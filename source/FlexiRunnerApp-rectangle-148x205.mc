...
class FlexiRunnerView extends Toybox.WatchUi.DataField {
    ...
    function onUpdate(dc) {
        ...
        dc.drawText(111, 136, Graphics.FONT_NUMBER_MEDIUM, (info.currentCadence != null) ? info.currentCadence : 0, Graphics.TEXT_JUSTIFY_CENTER|Graphics.TEXT_JUSTIFY_VCENTER);
        dc.drawText(112, 110, Graphics.FONT_XTINY, "Cadence", Graphics.TEXT_JUSTIFY_CENTER|Graphics.TEXT_JUSTIFY_VCENTER);
